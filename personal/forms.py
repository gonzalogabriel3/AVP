...
class formAgente(forms.ModelForm):
    ...
    iddireccion = forms.ModelChoiceField(required=False,queryset=Direccion.objects.all(),label="Direccion")
    iddireccionreal = forms.ModelChoiceField(required=False,queryset=Direccion.objects.all(),label="Direccion real")
